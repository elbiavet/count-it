        ...
        <div className="container-fluid vh-100 d-flex align-items-center justify-content-center">
            <div className="container-login col-11 col-sm-9 col-md-8 col-lg-6 col-xl-5 border border-primary border-2 rounded p-4 animate__animated animate__fadeIn">
                ...
                <form onSubmit={ handleSubmit(onSubmit) }>
                    ...
                    <div className="mb-3">
                        <label htmlFor="displayName" className="col-sm-2 col-form-label fs-5 fw-bold text-primary">Nombre</label>
                        <input 
                            type="text" 
                    ...
                    { !!errorMessage ? <p className="text-danger fw-bold"><i class="bi bi-exclamation-triangle m-2 fs-5"></i>{ errorMessage }</p> : ""}
                    
                    <div className="d-flex justify-content-evenly mt-4">
                        <button type="submit" className="btn btn-primary col-4 fs-5" disabled= { isAuthenticating }>Crear Cuenta</button>
                    </div>
